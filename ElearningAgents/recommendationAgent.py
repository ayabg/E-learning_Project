...
def llama_recommendation(user_id):
    ...
    prompt = (
        ...
        "Provide recommendations in the following format by only including the course ids in an array of strings and without including any additional text or description, just a list of course ids in this form (no code please): "
        "[courseid1, courseid2, courseid3, ...] REMINDER - Please provide recommendations in an array of strings in the format [courseid1, courseid2, courseid3, ...]"
